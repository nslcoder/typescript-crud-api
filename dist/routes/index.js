...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, description, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, title = _a.title, description = _a.description;
                return [4 /*yield*/, post_1.default.create({ title: title, description: description })];
            case 1:
                _b.sent();
...
exports.router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, title, description, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, title = _a.title, description = _a.description;
                return [4 /*yield*/, post_1.default.findByIdAndUpdate(id, { title: title, description: description })];
            case 1:
                _b.sent();
